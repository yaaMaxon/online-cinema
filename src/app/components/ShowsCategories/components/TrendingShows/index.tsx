...
// import { useTrendingShowsQuery } from "@/app/store/api/features/showApi";
...
// const TrendingShows = () => {
//   const { data: trendingShows } = useTrendingShowsQuery(null);

//   const [currentPage, setCurrentPage] = useState(0);
//   const itemsPerPage = 4;
//   const totalPages = Math.ceil(trendingShows?.results.length / itemsPerPage);

//   const handleNext = () => {
//     if ((currentPage + 1) * itemsPerPage < trendingShows?.results.length) {
...
//   const displayedTrending = trendingShows?.results.slice(
...
//             onClick={handleNext}
//             disabled={
//               (currentPage + 1) * itemsPerPage >= trendingShows?.results.length
//             }
//           >
//             <div className="bg-[#1A1A1A] border-[1px] border-[#1F1F1F] rounded-md p-2.5">
//               <ArrowRightIcon />
...
const TrendingShows = () => {
  ...
  const itemsPerPage = 4;
  const totalPages = Math.ceil(trendingShows?.results.length / itemsPerPage);
  const totalSlides = trendingShows?.results.length;
